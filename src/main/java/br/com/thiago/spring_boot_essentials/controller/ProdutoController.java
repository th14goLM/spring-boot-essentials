...
import br.com.thiago.spring_boot_essentials.database.model.ProdutoEntity;
import br.com.thiago.spring_boot_essentials.dto.ProdutoDto;
import br.com.thiago.spring_boot_essentials.exception.NotFoundException;
import br.com.thiago.spring_boot_essentials.service.ProdutoService;
...
public class ProdutoController {
    ...
    @PutMapping("/{id}")
    @ResponseStatus(HttpStatus.CREATED)
    public ProdutoEntity updateProduct(@PathVariable ("id") Integer id,
